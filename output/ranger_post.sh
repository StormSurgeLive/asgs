...
#
    ${OUTPUTDIR}/scp_files_ranger.exp ${OUTPUTDIR} $ADVISDIR $RESULTSHOST $RESULTSPATH $RESULTSPROMPT $RESULTSUSER $RESULTSPASSWORD $HOSTNAME $ENSTORM $OUTPUTPREFIX1 $OUTPUTPREFIX2
