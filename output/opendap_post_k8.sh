#!/bin/bash
#------------------------------------------------------------------------
# opendap_post_k8.sh : Makes results available to thredds data server.
#------------------------------------------------------------------------
...
echo "opendap_post -->> CYCLEDIR=$CYCLEDIR"
echo "opendap_post -->> CYCLE=$CYCLE"
...
echo "opendap_post -->> serverList=$serverList"
...
echo "opendap_post -->> SCENARIODIR=$SCENARIODIR"
