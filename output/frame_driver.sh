...
$ADCIRCDIR/aswip -m 2 -w $INPUT -a $ASWIPTIMESTEP $ASWIPFRAMEOPT -p $RMAX -x $VMAX
# write radial v and p
$ADCIRCDIR/aswip -m 2 -w $INPUT -v $ASWIPTIMESTEP $ASWIPFRAMEOPT -p $RMAX -x $VMAX
...
$ADCIRCDIR/aswip -m 2 -w $INPUT -s -p $RMAX -x $VMAX $ASWIPTIMESTEP $ASWIPFRAMEOPT $MESHFILEOPT # write spatial v and p
files=""
if [ $FRAME = "0" ]; then
