...
PERL5LIB=$6
MESHFILE=$7  # "0" if mesh should be autogenerated
#
export PERL5LIB
ASWIPTIMESTEP=""
VORTVIZTIMESTEP=""
...
echo "generating spatial wind field with $ADCIRCDIR/aswip -m 1 -s $ASWIPTIMESTEP $ASWIPFRAMEOPT $MESHFILEOPT"
$ADCIRCDIR/aswip -m 1 -s $ASWIPTIMESTEP $ASWIPFRAMEOPT $MESHFILEOPT # write spatial v and p
files=""
if [ $FRAME = "0" ]; then
