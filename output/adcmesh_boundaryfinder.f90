...
!-----------------------------------------------------------------------
!                         S U B R O U T I N E   
!                F I N D   M E S H   B O U N D A R I E S
!-----------------------------------------------------------------------
! Finds the boundaries nodes for an ADCIRC grid file given only 
! the node table and the element table. Makes use of the neighbor table 
! and is much faster than determining whether a side falls in two elements.                         
!-----------------------------------------------------------------------
subroutine findMeshBoundaries(m)
implicit none
type(mesh_t), intent(inout) :: m  ! mesh to operate on
...
!-----------------------------------------------------------------------
END SUBROUTINE findMeshBoundaries
!-----------------------------------------------------------------------
