...
PROGRAM FigureGen
        ...
        IF(MyRank.EQ.0)THEN
            ...
            WRITE(*,'(A)') " "
            WRITE(*,'(A)') "--------------------------------------"
            WRITE(*,'(A)') "FigureGen 49                2012/03/06"
            WRITE(*,'(A)') " "
...
SUBROUTINE CreateCPTFiles
        ...
        IF(ContourInterval.GT.ContourMax)THEN
           ContourInterval = ContourMax
        ENDIF
        IF(ScaleLabelEvery.GT.ContourMax)THEN
           ScaleLabelEvery = ContourMax
        ENDIF
...
!                       DO I=1,NumNodes1
                        DO I=1,NumNodesLocal
                            ...
                            IF((LongW.LE.X(I)).AND.(X(I).LE.LongE))THEN
                            IF((LatS .LE.Y(I)).AND.(Y(I).LE.LatN ))THEN
...
!... to the edges of the map.
      ...
      WRITE(UNIT=35,FMT='(A)') "      <description><![CDATA["//TRIM(PlotLabel)//"]]></description>"
      ...
      IF(INDEX(ContourFileType,"GRID-DECOMP").LE.0)THEN
         ...
         WRITE(UNIT=35,FMT='(A)') "         <screenXY  x="//ACHAR(34)//"0.00"//ACHAR(34)// &
                                                     ...
                                                     " xunits="//ACHAR(34)//"fraction"//ACHAR(34)// &
                                                     " yunits="//ACHAR(34)//"fraction"//ACHAR(34)//"/>"
         WRITE(UNIT=35,FMT='(A)') "         <size      x="//ACHAR(34)//"0.05"//ACHAR(34)// &
                                                     " y="//ACHAR(34)//"0.40"//ACHAR(34)// &
                                                     " xunits="//ACHAR(34)//"fraction"//ACHAR(34)// &
                                                     " yunits="//ACHAR(34)//"fraction"//ACHAR(34)//"/>"
...
SUBROUTINE GoogleKMZ
      ...
      IF(NumRecords.NE.0)THEN
         ...
         WRITE(UNIT=36,FMT='(A)') "      <description><![CDATA["//TRIM(PlotLabel)//"]]></description>"
...
!       ENDIF
        ...
        IF(IfPlotBoundaries.GE.1)THEN
            ...
            ELSEIF(TRIM(GridFileFormat).EQ."NETCDF")THEN
                ...
                CALL Check(NF90_INQ_DIMID(NC_ID,"neta",NC_Var))
                CALL Check(NF90_INQUIRE_DIMENSION(NC_ID,NC_Var,len=TotNumOpenBoundaryNodes))
#endif
            ENDIF
            ...
            IF(TRIM(GridFileFormat).EQ."NETCDF")THEN
                ...
                ALLOCATE(NC_OpenBoundEntry(1:NumOpenBoundaries,1:TotNumOpenBoundaryNodes))
            ...
            ELSEIF(TRIM(GridFileFormat).EQ."NETCDF")THEN
                ...
                CALL Check(NF90_INQ_DIMID(NC_ID,"nvel",NC_Var))
                CALL Check(NF90_INQUIRE_DIMENSION(NC_ID,NC_Var,len=TotNumLandBoundaryNodes))
#endif
            ENDIF
            ...
            IF(TRIM(GridFileFormat).EQ."NETCDF")THEN
                ...
                ALLOCATE(NC_LandBoundEntry(1:NumLandBoundaries,1:TotNumLandBoundaryNodes))
