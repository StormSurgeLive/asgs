...
%     The nhcConsensus for the current advsiory should be LAST in the array
    numEns = 4;
    ensFileNames = {'Adv13.nhcConsensus.fort.61.nc','Adv14.veerLeft100.fort.61.nc','Adv14.veerRight100.fort.61.nc','Adv14.nhcConsensus.fort.61.nc'};
    propFile = {'Adv13.nhcConsensus.run.properties','Adv14.veerLeft100.run.properties','Adv14.veerRight100.run.properties','Adv14.nhcConsensus.run.properties'};
    plotPrevious = true;
end
%
%%
...
fstations={'USACE 85625','USGS 073802332','USACE 76030','USACE 76265',...
    'USACE 82762','USACE 82770','USACE 82740','USACE 85760',...
...
% Station ID
stations={'85625','073802332','76030','76265','82762','82770','82740',...
