...
%     The nhcConsensus for the current advsiory should be LAST in the array
    numEns = 2;
    ensFileNames = {'NAM_2020060518.fort.61.nc','NAM_2020060600.fort.61.nc'};
    propFile = {'NAM_2020060518.run.properties','NAM_2020060600.run.properties'};
    plotPrevious = true;
end
%
%%
...
% Station ID
stations={'85625','073802332','76030','76265','82762','82770','82742',...
