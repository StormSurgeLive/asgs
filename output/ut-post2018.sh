#!/bin/bash
#------------------------------------------------------------------------
# ut-post2018.sh : Posting to opendap from lonestar5. 
#------------------------------------------------------------------------
...
# ~/asgs/trunk/output/ut-post2018.sh ~/asgs/config/asgs_config_phil_garnet_hsdrrs2014.sh /lustre/work1/jgflemin/asgs19368/38 99 2008 38 garnet.erdc.hpc.mil nhcConsensus 2008080800  2743200.000000000 HSDRRS2014_MRGO_leveeupdate_fixSTC_MX.grd  ~/asgs/trunk/output /u/jgflemin/asgs/log/asgs-2014-Apr-23-T05:33:41.19368.log ~/.ssh/id_rsa.pub
#
CONFIG=$1
ADVISDIR=$2
STORM=$3
...
for server in ${TDS[*]}; do
   ...
   for backup in ${TDS[*]}; do
      ...
      "copy"|"link")
         ...
         ;;
      *)
         warn "$ENSTORM: $THIS: OPeNDAP post method unrecognized."
         ;;
      esac
