#!/bin/bash
#-----------------------------------------------------------------------
# renci_ensemble_post.sh : Post processing for RENCI probabilistic
# ensemble (posting only to opendap). 
#-----------------------------------------------------------------------
...
COMMA_SEP_LIST="jason.g.fleming@gmail.com,bblanton@renci.org"
...
END
#
echo "INFO: renci_ensemble_post.sh: Sending 'results available' email to the following addresses: $COMMA_SEP_LIST." >> $SYSLOG
