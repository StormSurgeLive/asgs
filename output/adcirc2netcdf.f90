...
case('fort.64') !64
   dataRank = "2DVector"
   CALL Check(NF90_DEF_VAR(NC_ID,'u-vel',NF90_DOUBLE,NC_DimID,NC_VarID_uu1_vel))
   CALL Check(NF90_PUT_ATT(NC_ID,NC_VarID_uu1_vel,'_FillValue',FillValue))
   CALL Check(NF90_PUT_ATT(NC_ID,NC_VarID_uu1_vel,'long_name','water column vertically averaged east/west velocity'))
   CALL Check(NF90_PUT_ATT(NC_ID,NC_VarID_uu1_vel,'standard_name','eastward_water_velocity'))
   ...
   CALL Check(NF90_DEF_VAR(NC_ID,'v-vel',NF90_DOUBLE,NC_DimID,NC_VarID_vv1_vel))
   CALL Check(NF90_PUT_ATT(NC_ID,NC_VarID_vv1_vel,'_FillValue',FillValue))
   CALL Check(NF90_PUT_ATT(NC_ID,NC_VarID_vv1_vel,'long_name','water column vertically averaged north/south velocity'))
   CALL Check(NF90_PUT_ATT(NC_ID,NC_VarID_vv1_vel,'standard_name','northward_water_velocity'))
