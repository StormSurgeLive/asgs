...
{ASGSDevelopersGuide2011}) (\cite {BlainCA1998}) (\cite
{BlainCA2002}) (\cite{BlainCA2002}) (\cite {DietrichJC2012}) (\cite
...
{XieL2006})  (\cite {RamakrishnanL2006})(\cite
{KennedyA2010}) ( \cite{GlahnB2009})(\cite
{GlahnB2009}) (\cite{KimSC1996})(\cite {BlainCA2002Tidal})(\cite
{BlantonBO2012}) (\cite{VanCootenS2011})( \cite{BooijN1999})(\cite
{ChuP2009})
...
Point out the fact that that none of the automated ocean modeling 
systems in the literature mention the existence of any other 
...
the ADCIRC Surge Guidance System. Created ADCIRC symmetric vortex model.
Had an ensemble capability to vary storm parameters, with 5 preconfigured
ensemble members. Did not include SWAN, tidal forcing, or river forcing.
Only generated hydrographs plots in real time. 
