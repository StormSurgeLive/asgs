...
% stationnum=[8661070,8658120,8658163,8656483,8654467,
...
% % for cnt=1:nstat
% %    tmp=GetNosWaterLevelViaSOSv4_5('station',stationid{cnt},'start',start,'stop',stop,'datatype',datatype,'units',units,'vertdatum',vertdatum);
% %    if ~isempty(tmp)
% %       dat(cnt)=tmp;
% %    else
% %       nodata(cnt)=1;
