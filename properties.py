...
runProp = dict()
try: 
    f = open(options.directory + 'run.properties','r')
    for line in f:
        fields = line.split(':',1)
    ...
    print "properties.py: Could not open " + options.directory + "run.properties file."
    print "except"
    exit()
print "start"
#
...
if options.value != "null":
    ...
    try: 
        f = open(options.directory + 'run.properties','w')
