...
# Fundamental 
#
INSTANCENAME=td8lo        # name of this ASGS process
COLDSTARTDATE=2016072900
...
#RSSSITE=filesystem
#FTPSITE=filesystem
#FDIR=${SCRIPTDIR}/input/sample_advisories # forecast dir on nhc ftp site 
#HDIR=${SCRIPTDIR}/input/sample_advisories # hindcast dir on nhc ftp site 
...
VELSTATIONS=v6brivers_elev_stations.txt
