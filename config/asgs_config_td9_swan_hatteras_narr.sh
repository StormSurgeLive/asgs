...
# Fundamental 
#
INSTANCENAME=narrmine   # name of this ASGS process, used in differentiating results
COLDSTARTDATE=2016080200
...
INPUTDIR=${SCRIPTDIR}/input/meshes/narragansett # dir containing grid and other input files 
...
RSSSITE=filesystem
FTPSITE=filesystem
FDIR=~/asgs/2014stable/input/sample_advisories  # forecast dir on nhc ftp site 
HDIR=~/asgs/2014stable/input/sample_advisories  # hindcast dir on nhc ftp site 
...
GRIDFILE=narragansett_fort.14
GRIDNAME=narragansett_fort.14
MESHPROPERTIES=${GRIDFILE}.properties
CONTROLTEMPLATE=narragansett_fort.15.template
CONTROLPROPERTIES=${CONTROLTEMPLATE}.properties
ELEVSTATIONS=cera_stations_narragansett_20160802.txt
VELSTATIONS=null
METSTATIONS=cera_stations_narragansett_20160802.txt
NAFILE=narragansett_jgf_fort.13
...
#
# remove the archive so that it will be regenerated
# TODO: remove this as soon as the hindcast is complete ... it was only
# needed b/c the stations list was changed before the hindcast finished
# and the archive was created
rm $INPUTDIR/$HINDCASTARCHIVE
...
POSTPROCESS=hatteras_opendap_only_post.sh
