...
INSTANCENAME=v12hThreeThunder   # "name" of this ASGS process
COLDSTARTDATE=2017052000    # calendar year month day hour YYYYMMDDHH24
HOTORCOLD=hotstart        # "hotstart" or "coldstart"
#LASTSUBDIR=$SCRATCHDIR/v12hsetFlux/2017061618  # path to previous execution (if HOTORCOLD=hotstart)
...
TARGET=thunder  # used in post processing to pick up HPC platform config
