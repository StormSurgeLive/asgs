...
INSTANCENAME=natehsofsNG60cm    # "name" of this ASGS process
COLDSTARTDATE=2017071600    # calendar year month day hour YYYYMMDDHH24
HOTORCOLD=hotstart       # "hotstart" or "coldstart"
LASTSUBDIR=/projects/ncfs/data/asgs7800/2017100418  # path to previous execution (if HOTORCOLD=hotstart)
...
CONTROLTEMPLATE=hsofs_explicit_NG60cm.15.template  # fort.15 template
