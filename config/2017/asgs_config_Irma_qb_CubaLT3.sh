...
INSTANCENAME=irma     # "name" of this ASGS process
COLDSTARTDATE=2017081900 # calendar year month day hour YYYYMMDDHH24
...
ADCIRCDIR=/home/mbilskie/src/PADCIRC/v52.30/work # ADCIRC executables
SCRIPTDIR=/work/mbilskie/asgs/2014stable   # ASGS executables
#INPUTDIR=${SCRIPTDIR}/input/meshes/LA_v12b # grid and other input files
INPUTDIR=/work/mbilskie/asgs/CubaLT3/mesh # grid and other input files
...
SCRATCHDIR=/work/mbilskie/asgs/CubaLT3/irma #overides setting in platforms.sh -where state file will be written
...
NCPU=59                     # number of compute CPUs for all simulations
NCPUCAPACITY=240 
NUMWRITERS=1
CYCLETIMELIMIT="05:00:00"
QUEUENAME=workq
SERQUEUE=single
ACCOUNT=loni_lsu_crc_17
...
GRIDFILE=RelaxBdyLT3ReduxStep2.14 # mesh (fort.14) file
GRIDNAME=RelaxBdyLT3ReduxStep2
CONTROLTEMPLATE=RelaxBdyLT3ReduxStep2.15.template  # fort.15 template
ELEVSTATIONS=Cuba_Stations.txt   # or substitute your own stations file
VELSTATIONS=Cuba_Stations.txt
METSTATIONS=Cuba_Stations.txt
NAFILE=RelaxBdyLT3ReduxStep2.13
SWANTEMPLATE=RelaxBdyLT3ReduxStep2.26.template # only used if WAVES=on
...
POST_INIT_LIST="mbilsk3@lsu.edu"
