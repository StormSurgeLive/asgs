...
LASTSUBDIR=/work/jgflemin/asgs36552/16  # path to previous execution (if HOTORCOLD=hotstart)
...
INPUTDIR=/work/jgflemin/asgs/2014stable/input/meshes/texas2008_r35h # mesh and other input files
