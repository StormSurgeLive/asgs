...
INSTANCENAME=cindylah   # "name" of this ASGS process
COLDSTARTDATE=2017052018   # calendar year month day hour YYYYMMDDHH24
...
INPUTDIR=/work/jgflemin/asgs/2014stable/input/meshes/LA_v12g-WithUpperAtch # grid and other input files
...
HINDCASTARCHIVE=prepped_${GRIDNAME}_${INSTANCENAME}_${NCPU}.tar.gz
