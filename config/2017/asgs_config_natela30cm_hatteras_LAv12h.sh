...
INSTANCENAME=natela30cm    # "name" of this ASGS process
COLDSTARTDATE=2017090412 # calendar year month day hour YYYYMMDDHH24
HOTORCOLD=hotstart       # "hotstart" or "coldstart"
LASTSUBDIR=/projects/ncfs/data/asgs8880/initialize # path to previous execution (if HOTORCOLD=hotstart)
...
CONTROLTEMPLATE=LA_v12h-WithUpperAtch_chk_setFlux_30cm.15.template  # fort.15 template
