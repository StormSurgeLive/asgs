...
INSTANCENAME=irmahsofsowih    # "name" of this ASGS process
COLDSTARTDATE=2017071600    # calendar year month day hour YYYYMMDDHH24
HOTORCOLD=hotstart       # "hotstart" or "coldstart"
LASTSUBDIR=/projects/ncfs/data/asgs7800/2017090300 # path to previous execution (if HOTORCOLD=hotstart)
...
RSSSITE=filesystem
FTPSITE=filesystem
FDIR=/projects/ncfs/data/input/irma
HDIR=$FDIR
