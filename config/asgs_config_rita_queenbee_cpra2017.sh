...
INSTANCENAME=qb2rita     # "name" of this ASGS process
COLDSTARTDATE=2005081900 # calendar year month day hour YYYYMMDDHH24
...
RSSSITE=filesystem
FTPSITE=filesystem
FDIR=~/asgs/advisories
HDIR=~/asgs/advisories
