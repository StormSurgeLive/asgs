...
# Fundamental
INSTANCENAME=NGOMv19b_al262020_bde_10cm     # "name" of this ASGS process
ACCOUNT=ADCIRC
...
NAFILE=NGOM_RT_v19b_chk_10cm.13
...
GARFLUX=off              # variable river flux forcing
#STATICOFFSET=0.30
#
