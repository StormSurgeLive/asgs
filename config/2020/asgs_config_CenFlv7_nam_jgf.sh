...
INSTANCENAME=CenFlv7_nam_jgf  # "name" of this ASGS process
...
if [[ $HPCENVSHORT = stampede2 ]]; then
   ADCIRCDIR=/work/00976/jgflemin/stampede2/adcirc-cg/adcirc/v53release/work
   SWANDIR=/work/00976/jgflemin/stampede2/adcirc-cg/adcirc/v53release/swan
fi
