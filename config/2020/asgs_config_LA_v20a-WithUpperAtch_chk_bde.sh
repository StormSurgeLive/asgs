...
INSTANCENAME=LA_v20a-WithUpperAtch_chk_nam_bde     # "name" of this ASGS process
...
OPENDAPNOTIFY="asgs.cera.lsu@gmail.com,jason.g.fleming@gmail.com,asgsnotifications@opayq.com,clint@oden.utexas.edu,cera.asgs.tk@gmail.com,asgsnotes4ian@gmail.com"
