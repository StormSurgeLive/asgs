...
INSTANCENAME=EC95d_al132020_jgf  # "name" of this ASGS process
...
OPENDAPNOTIFY="asgs.cera.lsu@gmail.com,jason.g.fleming@gmail.com,rluettich1@gmail.com,cera.asgs.tk@gmail.com,asgsnotes4ian@gmail.com"
TDS=( lsu_tds )
