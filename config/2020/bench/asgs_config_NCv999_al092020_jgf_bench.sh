...
INSTANCENAME=NCv999_al092020_jgf_bench  # "name" of this ASGS process
...
HINDCASTLENGTH=20.0    # duration of tidal spinup, from cold (days)
...
LASTSUBDIR=http://tds.renci.org:8080/thredds/fileServer/2020/al09/28/nc_inundation_v9.99_w_rivers/hatteras.renci.org/ncv99-al092020-bob/veerRight100
...
-1)
   ...
   ;;
 0)
   ENSTORM=nhcConsensusNCPU0031
   NCPU=31
   ;; 
 1)
   ENSTORM=nhcConsensusNCPU0016
   NCPU=16
   ;;
 2)
   ENSTORM=nhcConsensusNCPU0008
   NCPU=8
   ;;
 3)
   ENSTORM=nhcConsensusNCPU0004
   NCPU=4
   ;;     
 4)
   ENSTORM=nhcConsensusNCPU0002
   NCPU=2
   ;;
 5)
   ENSTORM=nhcConsensusNCPU0001
   NCPU=1
   NUMWRITERS=0
   ;;        
*)
