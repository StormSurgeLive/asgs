...
INSTANCENAME=ncfs-dev-neflga-nam-master      # "name" of this ASGS process
...
CONTROLTEMPLATE=neflga_v12_geo_withsmag_template.15   # fort.15 template
...
BACKGROUNDMET=on          # NAM download/forcing
   FORECASTCYCLE="06,18"  #  "00,06,12,18"
