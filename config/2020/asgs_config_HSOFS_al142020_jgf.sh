...
INSTANCENAME=HSOFS_al142020_jgf  # "name" of this ASGS process
...
LASTSUBDIR=http://tds.renci.org:8080/thredds/fileServer/2020/nam/2020082006/hsofs/hatteras.renci.org/hsofs-nam-bob/namforecast
