...
INSTANCENAME=HSOFS_al062020_jgf_hindcast      # "name" of this ASGS process
...
TROPICALCYCLONE=on   # tropical cyclone forcing
   ...
   FDIR=$SCRIPTDIR/input/sample_advisories/2018/al062018_florence    # forecast dir on nhc ftp site
...
COLDSTARTDATE=2018081100   # calendar year month day hour YYYYMMDDHH24
