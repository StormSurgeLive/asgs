...
FORECASTWALLTIME="04:00:00" # must have leading zero, e.g., 05:00:00
NCPU=480
NUMWRITERS=0
NCPUCAPACITY=1920
...
CONTROLTEMPLATE=nc_9.99wrivers_vortex_withoffset_fort.15.template
...
OPENDAPNOTIFY="asgs.cera.lsu@gmail.com,jason.g.fleming@gmail.com,bblanton@renci.org"
