...
COLDSTARTDATE=2018072900 # calendar year month day hour YYYYMMDDHH24
...
ADCIRCDIR=/home1/02945/matt_bil/src/adcirc/adcirc-cg-52.30.14/work # ADCIRC executables
SCRIPTDIR=/scratch/02945/matt_bil/asgs/asgs_2014stable   # ASGS executables
INPUTDIR=/scratch/02945/matt_bil/asgs/NGOM_RT_v18j/mesh # grid and other input files
...
NCPU=527                    # number of compute CPUs for all simulations
NUMWRITERS=1 
NCPUCAPACITY=528 
CYCLETIMELIMIT="99:00:00"
QUEUENAME=skx-normal
SERQUEUE=skx-dev
ACCOUNT=TG-OCE140014       # Allocation name (req'd if you have more than 1)
SCRATCHDIR=/scratch/02945/matt_bil/asgs/NGOM_RT_v18j #overides setting in platforms.sh -where state file will be written
