...
INSTANCENAME=gordonHindcast_NGOM_RT_v18j   # "name" of this ASGS process
...
SCRATCHDIR=/worka/work/mbilskie/asgs/NGOM_RT_v18j/gordonHindcast #overides setting in platforms.sh -where state file will be written
