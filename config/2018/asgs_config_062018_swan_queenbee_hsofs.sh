...
LASTSUBDIR=http://tds.renci.org:8080/thredds/fileServer/tc/florence/38/hsofs/hatteras.renci.org/062018hsofs/nhcConsensus  # path to previous execution (if HOTORCOLD=hotstart)
...
CONTROLTEMPLATE=hsofs_offset_qb.15.template  # fort.15 template
