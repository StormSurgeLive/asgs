...
INSTANCENAME=142018hsofs    # "name" of this ASGS process
COLDSTARTDATE=2018091618       # YYYYMMDDHH24 or "auto" to extract from hotstart file
...
CONTROLTEMPLATE=hsofs_0.1524offset_qb.15.template  # fort.15 template
