...
INSTANCENAME=072018LAv17ah_12ft   # "name" of this ASGS process
COLDSTARTDATE=2018081200          # calendar year month day hour YYYYMMDDHH24
HOTORCOLD=hotstart       # "hotstart" or "coldstart"
LASTSUBDIR=/projects/ncfs/data/asgs5006/2018090306  # path to previous execution (if HOTORCOLD=hotstart)
