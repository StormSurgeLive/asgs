...
INSTANCENAME=isaacLAv17a  # "name" of this ASGS process
COLDSTARTDATE=auto        # calendar year month day hour YYYYMMDDHH24
HOTORCOLD=hotstart        # "hotstart" or "coldstart"
LASTSUBDIR=http://tds.renci.org:8080/thredds/fileServer/tc/isaac/24/LA_v17a-WithUpperAtch_chk/hatteras/isaacLAv17a/nhcConsensus    # path to previous execution (if HOTORCOLD=hotstart)
...
RSSSITE=filesystem
FTPSITE=filesystem
FDIR=~/asgs/branches/2014stable/input/sample_advisories/2012
HDIR=$FDIR
