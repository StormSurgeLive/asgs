...
INSTANCENAME=albertoNGOMv18j   # "name" of this ASGS process
...
SCRATCHDIR=/work/mbilskie/NGOM_RT_v18j/alberto #overides setting in platforms.sh -where state file will be written
