...
LASTSUBDIR=/ssdwork/mbilskie/asgs/NGOM_RT_v18j/asgs21302/2018090218 # path to previous execution (if HOTORCOLD=hotstart)
...
SCRIPTDIR=/ssdwork/mbilskie/asgs/2014_stable_09022018   # ASGS executables
...
SCRATCHDIR=/ssdwork/mbilskie/asgs/NGOM_RT_v18j/gordon #overides setting in platforms.sh -where state file will be written
...
RSSSITE=filesystem
FTPSITE=filesystem
FDIR=/ssdwork/mbilskie/asgs/NGOM_RT_v18j/gordon/advisories
HDIR=/ssdwork/mbilskie/asgs/NGOM_RT_v18j/gordon/advisories
