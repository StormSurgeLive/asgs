...
# Fundamental 
#
INSTANCENAME=jonas     # name of this ASGS process
COLDSTARTDATE=2015121900
...
INPUTDIR=${SCRIPTDIR}/input/meshes/femar2   # dir containing grid and other input files 
...
ELEVSTATIONS=FEMA_R2_elev_stations.txt
VELSTATIONS=null
METSTATIONS=FEMA_R2_met_stations.txt
NAFILE=FEMA_R2_01262012_refrac_fort.13
SWANTEMPLATE=FEMA_R2_fort.26.template
