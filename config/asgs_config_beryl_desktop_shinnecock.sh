...
INSTANCENAME=gahmtest    # "name" of this ASGS process
COLDSTARTDATE=2012052100 # calendar year month day hour YYYYMMDDHH24
...
HDIR=~/asgs/2014stable/input/sample_advisories
