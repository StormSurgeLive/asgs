...
INSTANCENAME=inlandwind    # "name" of this ASGS process
COLDSTARTDATE=2019062500 # calendar year month day hour YYYYMMDDHH24
HOTORCOLD=windonly      # "hotstart" | "coldstart" | "windonly"
...
SCRIPTDIR=~/asgs/jasonfleming/iw         # ASGS executables
INPUTDIR=${SCRIPTDIR}/input/meshes/wind_mesh   # grid and other input files
...
TIMESTEPSIZE=300.0            # adcirc time step size (seconds)
...
GRIDFILE=wind_mesh.14     # mesh (fort.14) file
GRIDNAME=wind_mesh
MESHPROPERTIES=${GRIDFILE}.properties
CONTROLTEMPLATE=wind_mesh.fort.15.template # fort.15 template
...
NAPROPERTIES=null
SWANTEMPLATE=null   # only used if WAVES=on
