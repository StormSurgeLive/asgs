...
INSTANCENAME=shinnam-serial    # "name" of this ASGS process
COLDSTARTDATE=2019030100 # calendar year month day hour YYYYMMDDHH24
...
POSTPROCESS=seahorse_opendap_post.sh
