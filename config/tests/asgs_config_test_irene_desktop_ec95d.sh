...
INSTANCENAME=vortextests # "name" of this ASGS process
COLDSTARTDATE=2011072200 # calendar year month day hour YYYYMMDDHH24
...
POSTPROCESS=test/irene_post.sh
TARGET=desktop
