...
INSTANCENAME=cindyhsofs    # "name" of this ASGS process
...
NCPU=1440                   # number of compute CPUs for all simulations
NUMWRITERS=8
NCPUCAPACITY=2896
...
QSCRIPT=hatteras.nopnor.template.slurm
PREPCONTROLSCRIPT=hatteras.nopnor.adcprep.template.slurm 
...
RMAX=default
PERCENT=default
ENSEMBLESIZE=5 # number of storms in the ensemble
case $si in
-1)
