...
INSTANCENAME=hermineFLFWJ # "name" of this ASGS process
COLDSTARTDATE=2016073100 # calendar year month day hour YYYYMMDDHH24
...
INPUTDIR=${SCRIPTDIR}/input/meshes/fl_fwj # grid and other input files
...
GRIDFILE=FL_FWJ_v1.05s.grd  # mesh (fort.14) file
GRIDNAME=FL_FWJ_v1.05s
MESHPROPERTIES=${GRIDFILE}.properties
CONTROLTEMPLATE=FL_FWJ_v1.05s.15.template   # fort.15 template
...
NAFILE=FL_FWJ_v1.05s_updated.13
