...
INSTANCENAME=zacklowriver  # "name" of this ASGS process
...
CONTROLTEMPLATE=cpra_2017_v12c_CurrentConditions_11kcms-WithUpperAtch_closed.15.template
CONTROLPROPERTIES=cpra_2017_v12c_CurrentConditions-WithUpperAtch_closed_11kcms.15.properties
