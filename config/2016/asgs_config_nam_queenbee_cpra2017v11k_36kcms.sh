...
INSTANCENAME=36kcms      # "name" of this ASGS process
COLDSTARTDATE=2015120100 # calendar year month day hour YYYYMMDDHH24
...
CONTROLTEMPLATE=cpra_2017_v07a_36kcms.15.template   # fort.15 template
...
MSRIVERBOUNDARYCONDITION='36kcms'
