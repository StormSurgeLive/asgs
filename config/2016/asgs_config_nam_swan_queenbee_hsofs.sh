...
INSTANCENAME=namqhsofs    # "name" of this ASGS process
COLDSTARTDATE=2016082912 # calendar year month day hour YYYYMMDDHH24
HOTORCOLD=hotstart       # "hotstart" or "coldstart"
LASTSUBDIR=/work/jgflemin/asgs25382/19  # path to previous execution (if HOTORCOLD=hotstart)
