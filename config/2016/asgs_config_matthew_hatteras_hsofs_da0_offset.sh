...
INSTANCENAME=matthsofsda0    # "name" of this ASGS process
...
LASTSUBDIR=/projects/ncfs/data/asgs18152/23 # path to previous execution (if HOTORCOLD=hotstart)
HINDCASTLENGTH=30.0      # length of initial hindcast, from cold (days)
REINITIALIZESWAN=no      # used to bounce the wave solution

# Source file paths

ADCIRCDIR=~/adcirc/branches/blendgahm_debug/work # ADCIRC executables
...
TRIGGER=rssembedded              # ftp, rss, rssembedded, or atcf
RSSSITE=filesystem
FTPSITE=filesystem
