...
INSTANCENAME=matthsofsdabest  # "name" of this ASGS process
#COLDSTARTDATE=2016090200     # calendar year month day hour YYYYMMDDHH24
COLDSTARTDATE=2016082912      # calendar year month day hour YYYYMMDDHH24
#HOTORCOLD=coldstart          # "hotstart" or "coldstart"
HOTORCOLD=hotstart            # "hotstart" or "coldstart"
LASTSUBDIR=/projects/ncfs/data/asgs6838/initialize # path to previous execution (if HOTORCOLD=hotstart)
...
TRIGGER=atcf              # ftp, rss, rssembedded, or atcf
RSSSITE=filesystem
FTPSITE=filesystem
FDIR=${SCRIPTDIR}/input/sample_advisories/2016
HDIR=$FDIR
...
CONTROLTEMPLATE=hsofs_nowcast_offset.15.template  # fort.15 template
#CONTROLTEMPLATE=hsofs_offset.15.template  # fort.15 template
CONTROLPROPERTIES=${CONTROLTEMPLATE}.properties
ELEVSTATIONS=hsofs.all_cera_stations_20161115.txt   # or substitute your own stations file
VELSTATIONS=hsofs.all_cera_stations_20161115.txt   
METSTATIONS=hsofs.all_cera_stations_20161115.txt   
NAFILE=hsofs.13
...
0)
   ...
   CONTROLTEMPLATE=hsofs_forecast_offset.15.template  # fort.15 template
   ;;
1)
   ENSTORM=veerRight50
   PERCENT=50
