...
INSTANCENAME=testike${USER}   # "name" of this ASGS process
COLDSTARTDATE=2008082015  # calendar year month day hour YYYYMMDDHH24
...
NCPU=20                      # number of compute CPUs for all simulations
NUMWRITERS=4
NCPUCAPACITY=72
...
#
# TODO: Substitute the post processing required for Texas
...
# opendap
#
# TODO: Fix the following so that it works for TACC THREDDS server
