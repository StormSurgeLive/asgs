...
# Fundamental 
#
INSTANCENAME=readyec95d      # name of this ASGS process (Change this for every new instance)
COLDSTARTDATE=2018090806  # (date to start cold start from )
...
ADCIRCDIR=$HOME/adcirc-cg/jasonfleming/v53release/work
SWANDIR=$HOME/adcirc-cg/jasonfleming/v53release/swan
SCRIPTDIR=$HOME/asgs/jasonfleming/2014stable   # ASGS scripts/executables  
...
RSSSITE=www.stormsurge.live  # www.nhc.noaa.gov 
FTPSITE=stormsurge.live      # ftp.nhc.noaa.gov  # real anon ftp site for hindcast/forecast files
...
INTENDEDAUDIENCE=developers-only # meta data audience
...
ARCHIVE=enstorm_pedir_removal.sh # if null no data gets save
