...
# RunID	  Meteorology	SWAN 	River	Spillway	Mesh
#   2	      NAM          off	actual closed	LAv19k

# Fundamental

INSTANCENAME=barryRun02      # "name" of this ASGS process
COLDSTARTDATE=auto           # calendar year month day hour YYYYMMDDHH24
HOTORCOLD=hotstart           # "hotstart" or "coldstart"
LASTSUBDIR=http://fortytwo.cct.lsu.edu:8080/thredds/fileServer/tc/nam/2019071006/LA_v19k-WithUpperAtch_chk/queenbee.loni.org/dailyLAv19k/namforecast
...
BACKGROUNDMET=OWI     # NAM download/forcing
