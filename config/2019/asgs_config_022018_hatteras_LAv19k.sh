...
LASTSUBDIR=http://fortytwo.cct.lsu.edu:8080/thredds/fileServer/tc/two/04/LA_v19k-WithUpperAtch_chk/queenbee.loni.org/al022019LAv19k/nhcConsensus    # path to previous execution (if HOTORCOLD=hotstart)
