...
INSTANCENAME=southfl_al052019hc_jgf     # "name" of this ASGS process
...
COLDSTARTDATE=auto
HOTORCOLD=hotstart
LASTSUBDIR=http://fortytwo.cct.lsu.edu:8080/thredds/fileServer/2019/al05/28/southfl_v11-1_final/supermic.hpc.lsu.edu/southfl_al052019_jgf/veerLeft100
#
