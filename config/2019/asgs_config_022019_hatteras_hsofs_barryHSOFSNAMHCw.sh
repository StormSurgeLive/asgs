...
INSTANCENAME=barryHSOFSNAMHCw    # "name" of this ASGS process
COLDSTARTDATE=auto  # calendar year month day hour YYYYMMDDHH24
HOTORCOLD=hotstart      # "hotstart" or "coldstart"
LASTSUBDIR=http://tds.renci.org:8080/thredds/fileServer/tc/nam/2019070806/hsofs/queenbee.loni.org/namhsofs/namforecast
