...
INSTANCENAME=readyLAv19k_jgf  # "name" of this ASGS process
...
LASTSUBDIR=http://fortytwo.cct.lsu.edu:8080/thredds/fileServer/2019/nam/2019082206/LA_v19k-WithUpperAtch_chk/queenbee.loni.org/dailyLAv19k/namforecast
