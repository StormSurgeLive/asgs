...
INSTANCENAME=testhiresr     # "name" of this ASGS process
...
LASTSUBDIR=http://fortytwo.cct.lsu.edu:8080/thredds/fileServer/tc/nam/2019031106/nc_inundation_v9.99_w_rivers/queenbee.loni.org/hiresr/namforecast
