...
# Fundamental 
#
INSTANCENAME=ncfs-dev-ec95d_2014stable      # name of this ASGS process (Change this for every new instance)
COLDSTARTDATE=2019031800  # (date to start cold start from )
...
SERQUEUE=single
#ACCOUNT=bblanton
SCRATCHDIR=/scratch/ncfs-dev/ec95d-2014stable  #  /projects/ncfs/data # for the NCFS on blueridge
CONSTRAINT=hatteras
PARTITION=batch
#QSCRIPT=hatteras.template.slurm # hatteras-revert.template.slurm
#PREPCONTROLSCRIPT=hatteras.adcprep.template.slurm # hatteras-revert.adcprep.template.slurm
...
INTENDEDAUDIENCE=ncfs-dev_ec95d # meta data audience
