...
# Fundamental 
#
INSTANCENAME=ncfs-dev-ec95d-nam_master    # name of this ASGS process (Change this for every new instance)
COLDSTARTDATE=2019070100  # (date to start cold start from )

STORMNAME=daily

HOTORCOLD=coldstart       # "hotstart" or "coldstart" 
LASTSUBDIR=null
HINDCASTLENGTH=23.0       # length of initial hindcast, from cold (days)  
...
SCRIPTDIR=/home/ncfs-dev/asgs.master/        # ASGS scripts/executables
...
SERQUEUE=null
#ACCOUNT=bblanton
SCRATCHDIR=/scratch/ncfs-dev/ec95d-master  #  /projects/ncfs/data # for the NCFS on blueridge
CONSTRAINT=hatteras
PARTITION=batch
...
SWANTEMPLATE=fort.26.ec95d.template   # no swan
...
INTENDEDAUDIENCE=systemTest # meta data audience
INITPOST=null_init_post.sh
POSTPROCESS=null_post.sh  #  blanton_rmq_test_post_hatteras.sh
...
ARCHIVEBASE=null  # /scratch/bblanton/asgs/
ARCHIVEDIR=null
