...
#-------------------------------------------------------------------
INSTANCENAME=lsustorm # the name for this instance of the ASGS
COLDSTARTDATE=2014071312     # date corresponding to simulation coldstart 
...
HINDCASTLENGTH=8.0            # length of initial hindcast, from cold (days)  COLDSTARTDATE + HINDCASTLENGTH must found in btk file. only used to set RNDAY for coldstart 
