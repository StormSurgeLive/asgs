...
LASTSUBDIR=null
ADCIRCDIR=/u/jgflemin/adcirc/nws_namelist/work # dir containing the ADCIRC executables 
INPUTDIR=/u/jgflemin/asgs/trunk/input   # dir containing grid and other input files 
...
PREPPEDARCHIVE=prepped_${INSTANCENAME}.tar.gz
HINDCASTARCHIVE=prepped_hc_${INSTANCENAME}.tar.gz
