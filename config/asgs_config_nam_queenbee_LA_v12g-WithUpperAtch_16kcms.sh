...
INSTANCENAME=testv12gAtch  # "name" of this ASGS process
...
GRIDNAME=LA_v12g-WithUpperAtch_chk
MESHPROPERTIES=${GRIDFILE}.properties
CONTROLTEMPLATE=LA_v12g-WithUpperAtch_chk_16kcms.15.template   # fort.15 template
