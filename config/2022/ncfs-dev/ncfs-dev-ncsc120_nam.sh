...
INSTANCENAME=ncsc120-nam-2022      # "name" of this ASGS process
...
#ADCIRCDIR=/home/ncfs-dev/ADCIRC/v55release_ncsc/work
ADCIRCDIR=/home/ncfs-dev/ADCIRC/v53release/work

# Input files and templates

GRIDNAME=NCSC_SAB_v1.20
...
COLDSTARTDATE=2022021500  #  2020080100  # calendar year month day hour YYYYMMDDHH24
...
TIDEFAC=on                # tide factor recalc
   HINDCASTLENGTH=23    # length of initial hindcast, from cold (days)
