...
INSTANCENAME=ec95d-nam-bob-adda      # "name" of this ASGS process
...
COLDSTARTDATE=2022011000  # calendar year month day hour YYYYMMDDHH24
...
BUILD_NOWCAST_SCENARIO=( output/prepare_dwlc_nowcast.sh )

FINISH_NOWCAST_SCENARIO=( output/opendap_post_nowcast.sh ) 

BUILD_FORECAST_SCENARIO=( output/prepare_dwlc_nowcast.sh )
