...
INSTANCENAME=ncsc123-nam-2022      # "name" of this ASGS process
...
COLDSTARTDATE=2022040100  #  2020080100  # calendar year month day hour YYYYMMDDHH24
...
TIDEFAC=on                # tide factor recalc
   HINDCASTLENGTH=22    # length of initial hindcast, from cold (days)
