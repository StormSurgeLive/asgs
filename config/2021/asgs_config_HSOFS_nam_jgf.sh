...
LASTSUBDIR=/work/jgflemin/asgs111683/initialize
...
case $si in
 ...
 -1)
  ...
  0)
    ...
    # binary or netcdf hotstart files
    HOTSTARTFORMAT=binary
    NCPU=959   # need to make this the same as the namforecast run b/c ASGS can't globalize/relocalize subdomain hotstart files
    ;;
  1)
    ENSTORM=namforecast
    ;;
