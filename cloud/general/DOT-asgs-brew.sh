...
help() {
  ...
  echo "   verify                     - verifies a growing number of aspects of the system, run without a specify run all tests"
  echo "          adcirc              - runs a test to ensure ADCIRC is built correctly"
  echo "          perl                - runs a test to ensure the Perl environment is set up correctly"
  echo "          python              - runs a test to ensure the Python environment is set up correctly, including modules like netCFF4"
